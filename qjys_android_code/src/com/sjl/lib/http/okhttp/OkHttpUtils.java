...
import com.sjl.lib.http.okhttp.builder.GetBuilder;
import com.sjl.lib.http.okhttp.builder.HeadBuilder;
import com.sjl.lib.http.okhttp.builder.OtherRequestBuilder;
import com.sjl.lib.http.okhttp.builder.PostFileBuilder;
import com.sjl.lib.http.okhttp.builder.PostFormBuilder;
import com.sjl.lib.http.okhttp.builder.PostStringBuilder;
import com.sjl.lib.http.okhttp.callback.Callback;
import com.sjl.lib.http.okhttp.cookie.CookieJarImpl;
...
public class OkHttpUtils {
	...
	public void setCertificates(InputStream[] certificates, InputStream bksFile, String password) {
		mOkHttpClient = getOkHttpClient().newBuilder()
				.sslSocketFactory(HttpsUtils.getSslSocketFactory(certificates, bksFile, password)).build();
	}
