 ...
 * 
 */
public class MeQRCreatActivity extends BaseActivity {
	private ImageView avator;
	private ImageView QRImage;
	private TextView name;
	private TextView hospitalroom;
	...
	protected void onCreate(Bundle arg0) {
		super.onCreate(arg0);
		setContentView(R.layout.qj_me_qrcode);
		setTitle("二维码名片");
		setLeftTitle("我");
    ...
    private String getFileRoot() {  
        return Environment.getExternalStorageDirectory() + "/qjys";  
    } 
