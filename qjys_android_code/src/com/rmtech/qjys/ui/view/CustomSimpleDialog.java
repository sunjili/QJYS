...
public class CustomSimpleDialog extends Dialog {  
    ...
    public CustomSimpleDialog(Context context, int theme) {  
        super(context, theme);  
    }  
    ...
    public static class Builder {  
        ...
        public CustomSimpleDialog create() {  
            ...
            final CustomSimpleDialog dialog = new CustomSimpleDialog(context, R.style.myCustomDialogStyle);  
            ...
            if (confirm_btnText != null) {  
                ...
                layout.findViewById(R.id.confirm_btn).setVisibility(  
                        View.GONE);  
                layout.findViewById(R.id.single_line).setVisibility(  
                        View.GONE);  
